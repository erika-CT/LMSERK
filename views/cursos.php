...
<section style="--delay:0.7s;" id="seccion-cursos" 
data-mixit="mixer_cursos" 
class="animado flex flex-col justify-center <?php if($pagina!="/cursos"){echo " hide";}?>">
        ...
        <div class="app-content ">
            ...
            <div class="projects-section">
                <div class="projects-section-header text-white">
                    <p class=" text-white"><?=$lan["cursos"]?></p>
                </div>
                <div class="projects-section-line">
                    <div class="projects-status">
                        <div class="item-status ocultar">
                            <span class="status-number curso-finalizado text-white">0</span>
                            <span class="status-type text-white">Finalizados</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number curso-proximo text-white">0</span>
                            <span class="status-type text-white">Proximos</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number curso-impartiendose text-white">0</span>
...
<section id="seccion-curso-detalle" class="flex flex-col justify-center hide "></section>