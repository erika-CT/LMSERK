<section style="--delay:0.7s;" id="seccion-categorias"  data-mixit="mixer_categorias" class="animado flex flex-col justify-center <?php if ($pagina != "/categorias") {
                                                                            echo " hide";
                                                                        } ?>">
    <div class="app-container dark:bg-[#000]/40 bg-[#fff]/40 rounded rounded-xl">
        ...
        <div class="app-header-left">
                ...
                <p class="app-name  text-white"><?=$lan["curso_administracion"]?></p>
            ...
            <div class="app-header-right">
                <button abrir-formulario data-formulario="nuevacategoria" class="add-btn" title="Add New Project">
                ...
                <div class="projects-section-line">
                    <div class="projects-status">
                        <div class="item-status">
                            <span class="status-number categorias activas text-white">0</span>
                            <span class="status-type text-white">Activas</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number categorias inactivas text-white">0</span>
                            <span class="status-type text-white">Inactivas</span>
                        </div>
