<section id="seccion-home" class="flex flex-col justify-center <?php 
if($pagina!="/home" && $pagina!="/" && $pagina!="/lmserk" && $pagina!="/index.php" ){
    echo " hide";
    }?>">
    <div class="main-container">

        <div class="user-box first-box">
            <div class="activity card animado" style="--delay: 1.2s">
            ...
            <div class="discount card animado" style="--delay: 1.4s">
            ...
            <div class="cards-wrapper animado" style="--delay: 1.6s">
            ...
            <div class="account-wrapper" style="--delay: 1.8s">
        ...
        <div class="user-box second-box">
            <div class="cards-wrapper" style="--delay: 2s">
                <div class="cards-header">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><svg viewBox="-22 0 134 134.06032" fill="currentColor">
                                        <path d="M23.347656 134.058594C8.445312 84.953125 39.933594 67.023438 39.933594 67.023438c-2.203125 26.203124 12.6875 46.617187 12.6875 46.617187 5.476562-1.652344 15.929687-9.375 15.929687-9.375 0 9.375-5.515625 29.78125-5.515625 29.78125s19.308594-14.929687 25.386719-39.726563c6.070313-24.796874-11.5625-49.691406-11.5625-49.691406 1.0625 17.550782-4.875 34.8125-16.507813 48 .582032-.671875 1.070313-1.417968 1.445313-2.226562 2.089844-4.179688 5.445313-15.042969 3.480469-40.199219C62.511719 14.890625 30.515625 0 30.515625 0c2.757813 21.515625-5.511719 26.472656-24.882813 67.3125-19.371093 40.832031 17.714844 66.746094 17.714844 66.746094zm0 0"></path>
                                    </svg></td>
                                <td>
            ...
            <div class="card transection" style="--delay: 2.5s">
    ...
    window.addEventListener('DOMContentLoaded', function(e) {
        if (document.getElementById("pagination-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            const dataTable = new simpleDatatables.DataTable("#pagination-table", {
                ...
                sortable: true,
                labels: {
                    placeholder: "Buscar...", // Label for search input
                    perPage: "resultados por página", // Label for per-page select box
                    noRows: "No se encontraron registros", // Message shown when no results are available
                    info: "Mostrando {start} a {end} de {rows} resultados" // Label for info text
                }
            });

            // After initializing the DataTable, target the search input and apply Flowbite classes

            // bg-gray-50 dark:bg-gray-700


            // Apply Flowbite classes
            $('input.datatable-input').addClass('shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light');

            $('#pagination-table thead').addClass('bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg')
            $('#pagination-table thead tr').addClass('rounded-lg bg-gray-50 dark:bg-gray-700')
            $('#pagination-table tbody tr td').addClass('text-center')
            $('#pagination-table thead tr:first-child th:first-child').addClass(['rounded-tl-lg', 'rounded-bl-lg']);
            $('#pagination-table thead tr:last-child th:last-child').addClass(['rounded-tr-lg', 'rounded-br-lg']);

            const $targetEl = document.getElementById('agregar-url');
