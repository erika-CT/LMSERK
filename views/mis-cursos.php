...
<section id="seccion-mis-cursos" data-mixit="mixer_mis_cursos" class="flex flex-col justify-center <?php if($pagina!="/mis-cursos"){echo " hide";}?>">
    <div class="app-container dark:bg-[#000]/40 bg-[#fff]/40 rounded rounded-xl">
        <div class="app-header">
            <div class="app-header-left">
                <span class="app-icon"></span>
                <p class=" app-name  text-white">Cursos en los que esta inscrito</p>
        ...
        <div class="app-content ">
            ...
            <div class="projects-section">
                <div class="projects-section-header text-white">
                    <p class=" text-white">Mis Cursos</p>
                </div>
                <div class="projects-section-line">
                    <div class="projects-status">
                        <div class="item-status">
                            <span class="status-number mis-cursos-finalizado text-white">0</span>
                            <span class="status-type text-white">Finalizados</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number mis-cursos-proximo text-white">0</span>
                            <span class="status-type text-white">Proximos</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number mis-cursos-impartiendose text-white">0</span>
                            <span class="status-type text-white">En desarrollo</span>
                        </div>
                    </div>
