<?php 
    $estudiantes_data = $db->get('estudiantes_activos_inactivos_bloqueados_count');
?>
<section
style="--delay:0.7s;"
data-mixit="mixer_estudiantes"
 id="seccion-estudiantes"
 class="animado flex flex-col justify-center <?php if ($pagina != "/estudiantes") {echo " hide";} ?>">
    <div class="app-container dark:bg-[#000]/40 bg-[#fff]/40 rounded rounded-xl">
        <div class="app-header">
            <div class="app-header-left">
                <span class="app-icon"></span>
                <p class="app-name  text-white"><?=$lan['estudiantes_administracion']?></p>
            ...
            <div class="app-header-right">
                ...
                <button abrir-formulario data-formulario="nuevoEstudiante" class="add-btn" title="Add New Project">
        ...
        <div class="app-content ">
            ...
            <div class="projects-section">
                <div class="projects-section-header text-white">
                    <p class=" text-white"><?=$lan['estudiantes']?></p>
                </div>
                <div class="projects-section-line">
                    <div class="projects-status">
                        <div class="item-status">
                            <span class="status-number estudiantes activos text-white"><?= $estudiantes_data["activos"]?></span>
                            <span class="status-type text-white">Activos</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number estudiantes inactivos text-white"><?=  $estudiantes_data["inactivos"]?></span>
                            <span class="status-type text-white">Inactivos</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number estudiantes bloqueados text-white"><?= $estudiantes_data["bloqueados"]?></span>
