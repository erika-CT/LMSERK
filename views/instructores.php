<?php 
    $instructores_data = $db->get('instructores_activos_inactivos_bloqueados_count');
?>
<section
data-mixit="mixer_instructores"
id="seccion-instructores"
style="--delay:0.7s;"
 class="animado flex flex-col justify-center <?php if ($pagina != "/instructores") {
                                                                            echo " hide";
                                                                        } ?>">
    <div class="app-container dark:bg-[#000]/40 bg-[#fff]/40 rounded rounded-xl">
        <div class="app-header">
            <div class="app-header-left">
                ...
                <p class="app-name  text-white"><?=$lan['instructor_administracion']?></p>
            ...
            <div class="app-header-right">
                ...
                <button abrir-formulario data-formulario="nuevoInstructor" class="add-btn" title="Add New Project">
        ...
        <div class="app-content ">
            ...
            <div class="projects-section">
                <div class="projects-section-header text-white">
                    <p class=" text-white"><?=$lan['instructores']?></p>
                </div>
                <div class="projects-section-line">
                    <div class="projects-status">
                        <div class="item-status">
                            <span class="status-number instructores activos text-white"><?= $instructores_data["activos"]?></span>
                            <span class="status-type text-white">Activos</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number instructores inactivos text-white"><?=  $instructores_data["inactivos"]?></span>
                            <span class="status-type text-white">Inactivos</span>
                        </div>
                        <div class="item-status">
                            <span class="status-number instructores bloqueados text-white"><?= $instructores_data["bloqueados"]?></span>
