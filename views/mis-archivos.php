...
<section id="seccion-mis-archivos" data-mixit="mixer_mis-archivos" class="flex flex-col justify-center <?php if($pagina!="/mis-archivos"){echo " hide";}?>">
        ...
        <div class="app-content ">
            ...
            <div class="projects-section">
                <div class="projects-section-header text-white">
                    <p class=" text-white"><?=$lan["mis-archivos"]?></p>
                </div>
