        ...
        var t = {
            ...
            853: function (t, e, i) {
                ...
                function z(t, e, i) {
                    ...
                    var n = t.getBoundingClientRect(),
                        r = 1,
                        o = 1;
                    e && C(t) && (r = t.offsetWidth > 0 && P(n.width) / t.offsetWidth || 1, o = t.offsetHeight > 0 && P(n.height) / t.offsetHeight || 1);
                ...
                function et(t) {
                    ...
                    if (f) {
                        var L = U(i),
                            A = "clientHeight",
                            C = "clientWidth";
                        L === I(i) && "static" !== W(L = R(i)).position && "absolute" === h && (A = "scrollHeight", C = "scrollWidth"), (d === n || (d === a || d === o) && c === l) && (D = r, _ -= (v && L === O && O.visualViewport ? O.visualViewport.height : L[A]) - s.height, _ *= p ? 1 : -1), d !== a && (d !== n && d !== r || c !== l) || (x = o, m -= (v && L === O && O.visualViewport ? O.visualViewport.width : L[C]) - s.width, m *= p ? 1 : -1)
                    }
                ...
                function vt(t, e, i, n) {
                    var r = "clippingParents" === e ? function (t) {
                        ...
                        s = o.reduce((function (e, i) {
                            var r = gt(t, i, n);
                            return e.top = H(r.top, e.top), e.right = j(r.right, e.right), e.bottom = j(r.bottom, e.bottom), e.left = H(r.left, e.left), e
                        }), gt(t, a, n));
                ...
                var bt = {
                    ...
                    fn: function (t) {
                        ...
                        if (!e.modifiersData[l]._skip) {
                            for (var u = i.mainAxis, h = void 0 === u || u, p = i.altAxis, f = void 0 === p || p, y = i.fallbackPlacements, m = i.padding, b = i.boundary, _ = i.rootBoundary, w = i.altBoundary, k = i.flipVariations, E = void 0 === k || k, x = i.allowedAutoPlacements, D = e.options.placement, O = M(D), L = y || (O !== D && E ? function (t) {
                                if (M(t) === s) return [];
                                var e = at(t);
                                return [dt(t), e, dt(e)]
                            }(D) : [at(D)]), I = [D].concat(L).reduce((function (t, i) {
                            ...
                            }), []), A = e.rects.reference, C = e.rects.popper, S = new Map, T = !0, H = I[0], j = 0; j < I.length; j++) {
                                var P = I[j],
                                    V = M(P),
                                    B = Z(P) === c,
                                    z = [n, r].indexOf(V) >= 0,
                            ...
                            if (L) {
                                if (l) {
                                    var V, B = "y" === D ? n : a,
                                        ...
                                        ct = W + ot - dt,
                                        lt = X(m ? j(q, W + rt - dt - st) : q, W, m ? H(R, ct) : R);
                                    L[D] = lt, P[D] = lt - W
                                }
                                if (h) {
                                    var ut, ht = "x" === D ? n : a,
            ...
            554: function (t, e) {
                ...
                function W(t) {
                    ...
                    return V[t] = {
                        parser: function (t, e) {
                            var n = t.split(P).reduce((function (t, e, n) {
                                if (e.length > 0 && i[n]) {
                                    var r = i[n][0];
                                    "M" === r ? t.m = e : "D" !== r && (t[r] = e)
                                }
                ...
                var tt = {
                    en: {
                        days: fechaLan.dias,
                        daysShort: fechaLan.diasCortos,
                        daysMin: fechaLan.diasMasCortos,
                        months: fechaLan.meses,
                        monthsShort: fechaLan.mesesCortos,
                        today: fechaLan.hoy,
                        clear: fechaLan.limpiar,
                        titleFormat: "MM y"
                    }
                },
                    et = {
                ...
                var zt = a((function t(e) {
                    ...
                    n.classList.add("datepicker-".concat(y)), "dropdown" === y && n.classList.add("dropdown", "absolute", "top-0", "left-0", "z-50", "pt-2"), jt(this, e.config), this.viewDate = Pt(e), X(e, [
                        [n, "click", Ht.bind(null, e), {
                            capture: !0
                        }],
                        [s, "click", Mt.bind(null, e)],
                        [v.viewSwitch, "click", Ct.bind(null, e)],
                        [v.prevBtn, "click", St.bind(null, e)],
                        [v.nextBtn, "click", Tt.bind(null, e)],
                        [v.todayBtn, "click", It.bind(null, e)],
                        [v.clearBtn, "click", At.bind(null, e)]
                    ...
                    value: function () {
                        if (!this.active) {
                            ...
                            if (!t.inline) {
                                var e = Bt(t.inputField);
                                e !== Bt(t.config.container) ? this.element.dir = e : this.element.dir && this.element.removeAttribute("dir"), this.place(), t.config.disableTouchKeyboard && t.inputField.blur()
                            }
                            xt(t, "show")
                        }
                    }
                    ...
                    value: function () {
                        var t, e, i, n = this.element,
                            ...
                            E = k.x,
                            x = k.y;
                        c === document.body ? (t = window.scrollY, e = m + window.scrollX, i = b + t) : (e = m - f, i = b - g + (t = c.scrollTop)), "auto" === E && (e < 0 ? (E = "left", e = 10) : E = e + u > v || "rtl" === Bt(d) ? "right" : "left"), "right" === E && (e -= u - _), "auto" === x && (x = i - h < t ? "bottom" : "top"), "top" === x ? i -= h : i += w, r.remove("datepicker-orient-top", "datepicker-orient-bottom", "datepicker-orient-right", "datepicker-orient-left"), r.add("datepicker-orient-".concat(x), "datepicker-orient-".concat(E)), o.top = i ? "".concat(i, "px") : i, o.left = e ? "".concat(e, "px") : e
                    }
                }, {
                    ...
                    key: "changeFocus",
                    value: function (t) {
                        return this._renderMethod = Vt(this, t) ? "render" : "refreshFocus", this.views.forEach((function (t) {
                            t.updateFocus()
                        })), this
                    }
                }, {
                    key: "update",
                    value: function () {
                        var t = Pt(this.datepicker);
                        return this._renderMethod = Vt(this, t) ? "render" : "refresh", this.views.forEach((function (t) {
                ...
                function Ft(t, e, i, n, r, o) {
                    if (k(t, r, o)) return n(t) ? Ft(e(t, i), e, i, n, r, o) : t
                }
                ...
                function Nt(t, e, i, n) {
                    ...
                    void 0 !== (c = Ft(c, r, i < 0 ? -d : d, o, s.minDate, s.maxDate)) && a.changeFocus(c).render()
                }
                ...
                function Gt(t, e, i) {
                    ...
                    var a = Xt(t, e, n);
                    a && (a.toString() !== t.dates.toString() ? (t.dates = a, $t(t, r ? 3 : 1), xt(t, "changeDate")) : $t(t, 1), o && t.hide())
                }
                var Qt = a((function t(e) {
                    var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    this.dates = [];
                    var h = Xt(this, s);
                    h && h.length > 0 && (this.dates = h), a && (a.value = Jt(this.dates, o));
                    var p = this.picker = new zt(this);
                    if (d) this.show();
                    else {
                        var f = Ut.bind(null, this),
                            g = [
                                [a, "keydown", Wt.bind(null, this)],
                                [a, "focus", qt.bind(null, this)],
                                [a, "mousedown", Rt.bind(null, this)],
                                [a, "click", Yt.bind(null, this)],
                                [a, "paste", Kt.bind(null, this)],
                    ...
                    value: function (t) {
                        var e = this.picker,
                            i = ft(t, this);
                        Object.assign(this._options, t), Object.assign(this.config, i), e.setOptions(i), $t(this, 3)
                    }
                }, {
                    key: "show",
                    value: function () {
                    ...
                    value: function () {
                        ...
                        t && "string" != typeof t && (e = t, t = void 0), $t(this, "picker" === t ? 2 : "input" === t ? 1 : 3, !e)
                    }
                }, {
                    key: "enterEditMode",
                    value: function () {
                ...
                var ie = a((function t(e) {
                    ...
                    if (!(n.length < 2)) {
                        ...
                        }), te(this, o, this.inputs[0], a), te(this, o, this.inputs[1], a), Object.freeze(s), s[0].dates.length > 0 ? ee(this, {
                            target: this.inputs[0]
                        }) : s[1].dates.length > 0 && ee(this, {
                    ...
                    value: function (t, e) {
                        var i = h(this.datepickers, 2),
                            ...
                            r = i[1],
                            o = this.dates;
                        this._updating = !0, n.setDate(t), r.setDate(e), delete this._updating, r.dates[0] !== o[1] ? ee(this, {
                            target: this.inputs[1]
                        }) : n.dates[0] !== o[0] && ee(this, {
                            target: this.inputs[0]
                        })
                    }
                }]);
                e.DateRangePicker = ie, e.Datepicker = Qt
            },
            902: function (t, e, i) {
            ...
            423: function (t, e) {
                ...
                var i = new (function () {
                    ...
                    return t.prototype.addInstance = function (t, e, i, n) {
                        if (void 0 === n && (n = !1), !this._instances[t]) return !1;
                        (!this._instances[t][i] || n) && (n && this._instances[t][i] && this._instances[t][i].destroyAndRemoveInstance(), this._instances[t][i || this._generateRandomId()] = e)
                    }, t.prototype.getAllInstances = function () {
                        return this._instances
                    }, t.prototype.getInstances = function (t) {
                        return !!this._instances[t] && this._instances[t]
                    }, t.prototype.getInstance = function (t, e) {
                        if (this._componentAndInstanceCheck(t, e) && this._instances[t][e]) return this._instances[t][e]
                        ...
                        return this._instances[t] && !!this._instances[t][e] || !1
                    }, t
                }());
